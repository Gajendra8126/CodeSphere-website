...
function TestimonialCard({ testimonial, index }: { testimonial: typeof testimonials[0]; index: number }) {
  ...
  return (
    <div
      ref={cardRef}
      className={`relative bg-card border border-border rounded-lg p-6 transition-all duration-500 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10 ${
...
export function TestimonialsSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-24 lg:py-32 bg-card border-y border-border overflow-hidden">
      {/* Grid background */}
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground mt-4 max-w-2xl mx-auto">
            See what developers from leading tech companies say about their CodeSphere experience.
          </p>
        </div>
